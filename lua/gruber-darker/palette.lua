...
M = {
  ...
  quartz      = Color.new(0xB584FF),
  ["niagara-2"] = Color.new(0x008C8C),
  ["niagara-1"] = Color.new(0xE9A4CB),
  niagara      = Color.new(0x9F84FF),
  wisteria     = Color.new(0xffffff),
}
